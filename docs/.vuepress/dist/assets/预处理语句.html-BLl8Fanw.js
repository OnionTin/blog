import{_ as n,o as s,c as a,e as t}from"./app-CilA4iky.js";const e={},p=t(`<h2 id="预处理语句" tabindex="-1"><a class="header-anchor" href="#预处理语句"><span>预处理语句</span></a></h2><p>解决 SQL 注入问题</p><div class="language-java line-numbers-mode" data-ext="java" data-title="java"><pre class="language-java"><code><span class="token comment">/*
 * 预处理语句的优点：
 * 1. 预编译，性能高
 * 2. 防止 SQL 注入

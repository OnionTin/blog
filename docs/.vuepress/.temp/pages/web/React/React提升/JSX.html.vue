...
<h3 id="什么是-jsx" tabindex="-1"><a class="header-anchor" href="#什么是-jsx"><span>什么是 JSX</span></a></h3>
<blockquote>
...
<h3 id="jsx-的基本使用" tabindex="-1"><a class="header-anchor" href="#jsx-的基本使用"><span>JSX 的基本使用</span></a></h3>
<ol>
<li><strong>返回单个元素</strong>：在 React 组件中，一个 JSX 表达式总是返回一个 React 元素。</li>
</ol>
...
<li><strong>使用表达式</strong>：你可以在 JSX 中直接使用 JavaScript 表达式，只需将它们放在大括号{}中。</li>
</ol>
<div class="language-jsx line-numbers-mode" data-ext="jsx" data-title="jsx"><pre v-pre class="language-jsx"><code><span class="token keyword">const</span> name <span class="token operator">=</span> <span class="token string">'Kimi'</span><span class="token punctuation">;</span>
...
<li><strong>列表渲染</strong>：JSX 允许在模板中插入数组，数组会自动展开所有成员。</li>
</ol>
...
<li><strong>样式</strong>：React 推荐使用内联样式，可以使用驼峰命名法来设置样式。</li>
</ol>
...
<li><strong>注释</strong>：在 JSX 中添加注释需要使用{/* */}。</li>
</ol>
<div class="language-jsx line-numbers-mode" data-ext="jsx" data-title="jsx"><pre v-pre class="language-jsx"><code><span class="token keyword">const</span> element <span class="token operator">=</span> <span class="token punctuation">(</span>
...
<span class="token punctuation">)</span><span class="token punctuation">;</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="jsx-的高级特性" tabindex="-1"><a class="header-anchor" href="#jsx-的高级特性"><span>JSX 的高级特性</span></a></h3>
<ol>
<li><strong>组件</strong>：在 JSX 中，大写开头的标签表示 React 组件。</li>
</ol>
...
<li><strong>Props</strong>：JSX 中的属性称为 props，可以通过属性传递数据给组件。</li>
</ol>
<div class="language-jsx line-numbers-mode" data-ext="jsx" data-title="jsx"><pre v-pre class="language-jsx"><code><span class="token keyword">const</span> element <span class="token operator">=</span> <span class="token punctuation">(</span>
...
<li><strong>Children</strong>：props.children 是特殊的 prop，它包含了组件的子元素。</li>
</ol>
<div class="language-jsx line-numbers-mode" data-ext="jsx" data-title="jsx"><pre v-pre class="language-jsx"><code><span class="token keyword">function</span> <span class="token function">MyComponent</span><span class="token punctuation">(</span><span class="token parameter">props</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
...
<li><strong>Fragment</strong>：使用&lt;&gt;和&lt;/&gt;可以创建一个没有额外节点的分组。</li>
</ol>
<div class="language-jsx line-numbers-mode" data-ext="jsx" data-title="jsx"><pre v-pre class="language-jsx"><code><span class="token keyword">const</span> element <span class="token operator">=</span> <span class="token punctuation">(</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="jsx-的注意事项" tabindex="-1"><a class="header-anchor" href="#jsx-的注意事项"><span>JSX 的注意事项</span></a></h3>
<ol>
<li><strong>首字母大写</strong>：自定义组件的标签名必须首字母大写。</li>
</ol>
...
<li><strong>自闭合标签</strong>：像<img />这样的标签在 JSX 中需要以自闭合形式出现。</li>
</ol>
<div class="language-jsx line-numbers-mode" data-ext="jsx" data-title="jsx"><pre v-pre class="language-jsx"><code><span class="token keyword">const</span> element <span class="token operator">=</span> <span class="token punctuation">(</span>
...
<li><strong>事件命名</strong>：React 事件使用驼峰式命名，而不是全部小写。</li>
</ol>
...
<li><strong>安全性</strong>：React 在渲染之前会对所有输入内容进行转义，以防止 XSS 攻击。</li>
</ol>
...
<li><strong>性能优化</strong>：避免在渲染方法中创建新的 JSX 元素，应该使用缓存的元素或使用 React.memo 进行优化。</li>
</ol>

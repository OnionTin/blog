<template><div><!-- @format -->
<h2 id="自定义-hooks" tabindex="-1"><a class="header-anchor" href="#自定义-hooks"><span>自定义 Hooks</span></a></h2>
<p>自定义 Hooks 是一种在 React 中复用状态逻辑的高级技巧。它们让你可以在多个组件之间重用状态逻辑而不必直接复用类组件的代码。通过封装状态逻辑和副作用，自定义 Hooks 让你的组件更加简洁和清晰。</p>
<h3 id="_1-使用-hooks-的规则" tabindex="-1"><a class="header-anchor" href="#_1-使用-hooks-的规则"><span>1. 使用 Hooks 的规则</span></a></h3>
<ul>
<li>只能在函数组件的顶层使用 Hooks。</li>
<li>不要在循环、条件语句或嵌套函数中调用 Hooks。</li>
</ul>
<h3 id="_2-创建自定义-hook" tabindex="-1"><a class="header-anchor" href="#_2-创建自定义-hook"><span>2. 创建自定义 Hook</span></a></h3>
<p>自定义 Hook 是通过在函数前面加上<code v-pre>use</code>前缀来创建的，它是一个 JavaScript 函数。</p>
<div class="language-jsx line-numbers-mode" data-ext="jsx" data-title="jsx"><pre v-pre class="language-jsx"><code><span class="token keyword">function</span> <span class="token function">useMyCustomHook</span><span class="token punctuation">(</span><span class="token parameter">input</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
  <span class="token comment">// ...状态逻辑</span>
  <span class="token keyword">return</span> someValue<span class="token punctuation">;</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_3-使用-usestate-和-useeffect" tabindex="-1"><a class="header-anchor" href="#_3-使用-usestate-和-useeffect"><span>3. 使用 useState 和 useEffect</span></a></h3>
<p>自定义 Hooks 内部可以使用其他 Hooks，如<code v-pre>useState</code>和<code v-pre>useEffect</code>。</p>
<div class="language-jsx line-numbers-mode" data-ext="jsx" data-title="jsx"><pre v-pre class="language-jsx"><code><span class="token keyword">function</span> <span class="token function">useUser</span><span class="token punctuation">(</span><span class="token parameter">name</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_4-暴露公共-api" tabindex="-1"><a class="header-anchor" href="#_4-暴露公共-api"><span>4. 暴露公共 API</span></a></h3>
<p>自定义 Hook 应该暴露一个公共 API，这样其他组件就可以使用它。</p>
<div class="language-jsx line-numbers-mode" data-ext="jsx" data-title="jsx"><pre v-pre class="language-jsx"><code><span class="token keyword">function</span> <span class="token function">useUser</span><span class="token punctuation">(</span><span class="token parameter">name</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
  <span class="token comment">// ...状态逻辑</span>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_5-参数化" tabindex="-1"><a class="header-anchor" href="#_5-参数化"><span>5. 参数化</span></a></h3>
<p>自定义 Hook 可以接受参数，使其更加灵活和通用。</p>
<div class="language-jsx line-numbers-mode" data-ext="jsx" data-title="jsx"><pre v-pre class="language-jsx"><code><span class="token keyword">function</span> <span class="token function">useFetchData</span><span class="token punctuation">(</span><span class="token parameter">url</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_6-使用自定义-hook" tabindex="-1"><a class="header-anchor" href="#_6-使用自定义-hook"><span>6. 使用自定义 Hook</span></a></h3>
<p>在组件中使用自定义 Hook，就像使用内置 Hook 一样。</p>
<div class="language-jsx line-numbers-mode" data-ext="jsx" data-title="jsx"><pre v-pre class="language-jsx"><code><span class="token keyword">function</span> <span class="token function">UserProfile</span><span class="token punctuation">(</span><span class="token parameter"><span class="token punctuation">{</span> userName <span class="token punctuation">}</span></span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_7-命名约定" tabindex="-1"><a class="header-anchor" href="#_7-命名约定"><span>7. 命名约定</span></a></h3>
<p>自定义 Hook 的命名应该以<code v-pre>use</code>为前缀，并且能够清晰地表达其功能。</p>
<h3 id="_8-避免副作用" tabindex="-1"><a class="header-anchor" href="#_8-避免副作用"><span>8. 避免副作用</span></a></h3>
<p>自定义 Hook 的主要目的是封装状态逻辑，而不是副作用。副作用应该在组件内部使用<code v-pre>useEffect</code>处理。</p>
<h3 id="_9-使用自定义-hook-进行性能优化" tabindex="-1"><a class="header-anchor" href="#_9-使用自定义-hook-进行性能优化"><span>9. 使用自定义 Hook 进行性能优化</span></a></h3>
<p>自定义 Hook 可以用于封装性能优化逻辑，如 memoization、throttling 或 debouncing。</p>
<div class="language-jsx line-numbers-mode" data-ext="jsx" data-title="jsx"><pre v-pre class="language-jsx"><code><span class="token keyword">function</span> <span class="token function">useDebounce</span><span class="token punctuation">(</span><span class="token parameter">value<span class="token punctuation">,</span> delay</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_10-自定义-hook-的组合" tabindex="-1"><a class="header-anchor" href="#_10-自定义-hook-的组合"><span>10. 自定义 Hook 的组合</span></a></h3>
<p>你可以创建多个自定义 Hook，并将它们组合起来使用。</p>
</div></template>

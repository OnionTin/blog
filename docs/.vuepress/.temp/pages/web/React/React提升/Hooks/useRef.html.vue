...
<p><code v-pre>useRef</code> 是 React 提供的 Hook，用于在函数组件中访问 DOM 元素、管理内部状态或保存任何可变值。</p>
<h3 id="_1-基本使用" tabindex="-1"><a class="header-anchor" href="#_1-基本使用"><span>1. 基本使用</span></a></h3>
<p><code v-pre>useRef</code> 创建一个可变的 ref 对象，它在整个组件生命周期内持续存在。</p>
...
<p><code v-pre>useRef</code> 常用于直接访问 DOM 元素，如获取输入字段或按钮。</p>
<div class="language-jsx line-numbers-mode" data-ext="jsx" data-title="jsx"><pre v-pre class="language-jsx"><code><span class="token keyword">function</span> <span class="token function">TextInput</span><span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_3-初始值" tabindex="-1"><a class="header-anchor" href="#_3-初始值"><span>3. 初始值</span></a></h3>
<p><code v-pre>useRef</code> 可以接受一个初始值，该值将在组件挂载时被设置。</p>
<div class="language-jsx line-numbers-mode" data-ext="jsx" data-title="jsx"><pre v-pre class="language-jsx"><code><span class="token keyword">const</span> ref <span class="token operator">=</span> <span class="token function">useRef</span><span class="token punctuation">(</span>initialValue<span class="token punctuation">)</span><span class="token punctuation">;</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h3 id="_4-保存可变值" tabindex="-1"><a class="header-anchor" href="#_4-保存可变值"><span>4. 保存可变值</span></a></h3>
<p><code v-pre>useRef</code> 可以用来保存任何可变值，这个值在组件的整个生命周期内持续存在。</p>
<div class="language-jsx line-numbers-mode" data-ext="jsx" data-title="jsx"><pre v-pre class="language-jsx"><code><span class="token keyword">function</span> <span class="token function">Timer</span><span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_5-传递回调函数" tabindex="-1"><a class="header-anchor" href="#_5-传递回调函数"><span>5. 传递回调函数</span></a></h3>
<p><code v-pre>useRef</code> 可以用于保存回调函数，确保回调函数的稳定性。</p>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_6-组合使用" tabindex="-1"><a class="header-anchor" href="#_6-组合使用"><span>6. 组合使用</span></a></h3>
<p><code v-pre>useRef</code> 可以与 <code v-pre>useEffect</code> 组合使用，以处理副作用。</p>
<div class="language-jsx line-numbers-mode" data-ext="jsx" data-title="jsx"><pre v-pre class="language-jsx"><code><span class="token keyword">import</span> <span class="token punctuation">{</span> useRef<span class="token punctuation">,</span> useEffect <span class="token punctuation">}</span> <span class="token keyword">from</span> <span class="token string">'react'</span><span class="token punctuation">;</span>
...
<p>虽然 <code v-pre>useRef</code> 创建的 ref 对象在组件卸载后仍然存在，但可以通过手动设置 <code v-pre>null</code> 来清除。</p>
<div class="language-jsx line-numbers-mode" data-ext="jsx" data-title="jsx"><pre v-pre class="language-jsx"><code><span class="token keyword">function</span> <span class="token function">MyComponent</span><span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
  <span class="token keyword">const</span> myRef <span class="token operator">=</span> <span class="token function">useRef</span><span class="token punctuation">(</span><span class="token keyword">null</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
...
<p>可以在一个组件中使用多个 ref，只要每个 ref 都有唯一的引用。</p>
<h3 id="_9-与类组件的区别" tabindex="-1"><a class="header-anchor" href="#_9-与类组件的区别"><span>9. 与类组件的区别</span></a></h3>
<p>在类组件中，通常使用<code v-pre>React.createRef</code>创建 ref，而在函数组件中使用<code v-pre>useRef</code>。</p>
<h3 id="_10-refs-与-context" tabindex="-1"><a class="header-anchor" href="#_10-refs-与-context"><span>10. Refs 与 Context</span></a></h3>
<p><code v-pre>useRef</code> 可以与 <code v-pre>useContext</code> 结合使用，以在组件树中传递 DOM 元素引用。</p>
<h3 id="_11-refs-与-forwardref" tabindex="-1"><a class="header-anchor" href="#_11-refs-与-forwardref"><span>11. Refs 与 forwardRef</span></a></h3>
<p><code v-pre>useRef</code> 可以与 <code v-pre>forwardRef</code> 结合使用，以将 ref 传递给子组件。</p>
<div class="language-jsx line-numbers-mode" data-ext="jsx" data-title="jsx"><pre v-pre class="language-jsx"><code><span class="token keyword">import</span> React<span class="token punctuation">,</span> <span class="token punctuation">{</span> forwardRef <span class="token punctuation">}</span> <span class="token keyword">from</span> <span class="token string">'react'</span><span class="token punctuation">;</span>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_12-refs-与-useimperativehandle" tabindex="-1"><a class="header-anchor" href="#_12-refs-与-useimperativehandle"><span>12. Refs 与 useImperativeHandle</span></a></h3>
<p>当使用 <code v-pre>forwardRef</code> 时，<code v-pre>useImperativeHandle</code> 可以用于控制子组件暴露给父组件的实例值。</p>
<h3 id="_13-调试" tabindex="-1"><a class="header-anchor" href="#_13-调试"><span>13. 调试</span></a></h3>
<p><code v-pre>useRef</code> 可以用于调试目的，如保存组件的特定状态或日志信息。</p>
</div></template>

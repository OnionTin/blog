<template><div><h2 id="redux" tabindex="-1"><a class="header-anchor" href="#redux"><span>redux</span></a></h2>
<table>
<thead>
<tr>
<th>名称</th>
...
<p>明确两个概念：</p>
<ol>
<li>UI 组件：不能使用任何 Redux 的 API，只负责页面的呈现和交互。</li>
<li>容器组件：负责与 Redux 通信，将结果传递给 UI 组件。</li>
</ol>
<p>如何创建一个容器组件：</p>
<p>通过使用 react-redux 的 connect 函数。
connect 函数接受两个参数：mapStateToProps 和 mapDispatchToProps。
mapStateToProps：映射状态，用于将 Redux 的状态映射到 UI 组件的 props。
mapDispatchToProps：映射操作状态的方法，返回值是一个对象。</p>
<p>注意：</p>
<p>容器组件中的 store 是通过 props 传递进去的，而不是在容器组件中直接引入。</p>
</blockquote>
<blockquote>
<p>connect(参数, 方法)(UI 组件): 容器组件，用来链接 ui 组件和 redux 的，ui 组件只能用来展示，所以必须在外层包裹一个容器组件做数据的处理工作；(注意: 因为 react-redux 帮做处理了,所以 store 和其中的 state 和 dispatch 就可以直接拿到了)</p>
</blockquote>
<blockquote>
<p>reducer 必须是纯函数，纯函数: redux 中数组的处理不能用 push 和 unshift 的原因，不是纯函数，改变了原来的数组的引用类型数组的指向，改变了原数组，不能用，所以只能用[...oldArr, data]；用[...oldArr],原本的 oldArr 没有改变。</p>
</blockquote>
<h3 id="整体案例一" tabindex="-1"><a class="header-anchor" href="#整体案例一"><span>整体案例一</span></a></h3>
<div class="language-javascript line-numbers-mode" data-ext="js" data-title="js"><pre v-pre class="language-javascript"><code><span class="token keyword">import</span> React <span class="token keyword">from</span> <span class="token string">"react"</span><span class="token punctuation">;</span>
...
<span class="token punctuation">)</span><span class="token punctuation">;</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="整体案例二" tabindex="-1"><a class="header-anchor" href="#整体案例二"><span>整体案例二</span></a></h3>
<div class="language-jsx line-numbers-mode" data-ext="jsx" data-title="jsx"><pre v-pre class="language-jsx"><code><span class="token comment">// UI组件</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><div class="language-jsx line-numbers-mode" data-ext="jsx" data-title="jsx"><pre v-pre class="language-jsx"><code><span class="token comment">// 如何使用connect函数的简写形式来连接UI组件和Redux</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="纯函数" tabindex="-1"><a class="header-anchor" href="#纯函数"><span>纯函数</span></a></h3>
<blockquote>
<p>纯函数是一类特别的函数，它们必须遵守以下约束：</p>
</blockquote>
<ol>
<li><strong>相同的输入总是得到相同的输出</strong>：只要是同样的输入（实参），必定得到同样的输出（返回）。</li>
<li><strong>必须遵守的约束</strong>：
<ol>
<li>不得改写参数数据。</li>
<li>不会产生任何副作用，例如网络请求，输入和输出设备。</li>
<li>不能调用 <code v-pre>Date.now()</code> 或 <code v-pre>Math.random()</code> 等不纯的方法。</li>
</ol>
</li>
</ol>
<font color=red>Redux 的 `reducer` 函数必须是一个纯函数。</font><h3 id="高阶函数" tabindex="-1"><a class="header-anchor" href="#高阶函数"><span>高阶函数</span></a></h3>
<blockquote>
<p>高阶函数是一类特别的函数，它们可以：</p>
</blockquote>
<ol>
<li><strong>参数是函数</strong>：接收一个或多个函数作为参数。</li>
<li><strong>返回是函数</strong>：返回一个函数。</li>
<li><strong>定时器设置函数</strong>：如 <code v-pre>setTimeout</code> 或 <code v-pre>setInterval</code>，它们的回调参数是一个函数。</li>
<li><strong>数组的方法</strong>：
<ul>
<li><code v-pre>forEach()</code></li>
<li><code v-pre>map()</code></li>
<li><code v-pre>filter()</code></li>
<li><code v-pre>reduce()</code></li>
<li><code v-pre>find()</code></li>

<template><div><h2 id="react-类型检查" tabindex="-1"><a class="header-anchor" href="#react-类型检查"><span>react 类型检查</span></a></h2>
<p>基础数据类型:</p>
<table>
<thead>
<tr>
...
<tbody>
<tr>
<td style="text-align:center">PropTypes.element</td>
<td style="text-align:center">检查 React 元素</td>
</tr>
<tr>
<td style="text-align:center">PropTypes.elementType</td>
<td style="text-align:center">检查 React 元素类型</td>
</tr>
<tr>
<td style="text-align:center">PropTypes.instanceOf(class)</td>
<td style="text-align:center">检查是否是某个类的实例</td>
</tr>
</tbody>
</table>
<p>其他类型:</p>
...
<tbody>
<tr>
<td style="text-align:center">PropTypes.node</td>
<td style="text-align:center">检查任何可以被渲染的 React 元素</td>
</tr>
<tr>
<td style="text-align:center">PropTypes.objectOf(type)</td>
<td style="text-align:center">检查对象中的所有值是否是某个类型</td>
</tr>
<tr>
<td style="text-align:center">PropTypes.shape(obj)</td>
<td style="text-align:center">检查对象是否具有某些属性</td>
</tr>
<tr>
<td style="text-align:center">PropTypes.any</td>
<td style="text-align:center">检查任何类型</td>
</tr>
<tr>
<td style="text-align:center">PropTypes.oneOf(values)</td>
<td style="text-align:center">检查值是否在某个数组中</td>
</tr>
<tr>
<td style="text-align:center">PropTypes.oneOfType(types)</td>
<td style="text-align:center">检查值是否是某个类型的子类型</td>
</tr>
</tbody>
</table>
<h3 id="arrof-和-objectof-多重嵌套类型检测" tabindex="-1"><a class="header-anchor" href="#arrof-和-objectof-多重嵌套类型检测"><span>arrOf 和 objectOf 多重嵌套类型检测</span></a></h3>
<div class="language-jsx line-numbers-mode" data-ext="jsx" data-title="jsx"><pre v-pre class="language-jsx"><code><span class="token comment">// An array of a certain type</span>
...
<div class="language-jsx line-numbers-mode" data-ext="jsx" data-title="jsx"><pre v-pre class="language-jsx"><code><span class="token comment">// An object taking on a particular shape</span>

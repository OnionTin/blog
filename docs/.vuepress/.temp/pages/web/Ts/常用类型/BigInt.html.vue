<template><div><h2 id="bigint" tabindex="-1"><a class="header-anchor" href="#bigint"><span>BigInt</span></a></h2>
<blockquote>
...
<h3 id="创建-bigint" tabindex="-1"><a class="header-anchor" href="#创建-bigint"><span>创建 BigInt</span></a></h3>
<blockquote>
<p>可以通过在整数后面添加 n 后缀，或者使用 BigInt() 函数创建 BigInt。</p>
</blockquote>
<div class="language-typescript line-numbers-mode" data-ext="ts" data-title="ts"><pre v-pre class="language-typescript"><code><span class="token comment">// 使用 n 后缀</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="bigint-运算" tabindex="-1"><a class="header-anchor" href="#bigint-运算"><span>BigInt 运算</span></a></h3>
<blockquote>
<p>BigInt 支持标准的算术运算符，如 +, -, *, / 等</p>
</blockquote>
<div class="language-typescript line-numbers-mode" data-ext="ts" data-title="ts"><pre v-pre class="language-typescript"><code><span class="token keyword">const</span> sum <span class="token operator">=</span> bigNumber1 <span class="token operator">+</span> bigNumber2<span class="token punctuation">;</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="类型检查" tabindex="-1"><a class="header-anchor" href="#类型检查"><span>类型检查</span></a></h3>
<blockquote>
<p>使用 typeof 检查 BigInt 类型时，返回值为 &quot;bigint&quot;。</p>
</blockquote>
<div class="language-typescript line-numbers-mode" data-ext="ts" data-title="ts"><pre v-pre class="language-typescript"><code><span class="token keyword">typeof</span> <span class="token number">10n</span> <span class="token operator">===</span> <span class="token string">"bigint"</span><span class="token punctuation">;</span> <span class="token comment">// true</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="注意事项" tabindex="-1"><a class="header-anchor" href="#注意事项"><span>注意事项</span></a></h3>
<blockquote>
<ol>
<li>
<p>BigInt 不能与 Number 类型混合运算，必须显式转换。</p>
</li>
<li>
<p>BigInt 不支持 Math 库中的函数。</p>
</li>
<li>
<p>转换 BigInt 为 Number 可能会导致精度丢失。</p>
</li>
</ol>
</blockquote>
<div class="language-typescript line-numbers-mode" data-ext="ts" data-title="ts"><pre v-pre class="language-typescript"><code><span class="token keyword">const</span> theBiggestInt <span class="token operator">=</span> <span class="token number">9007199254740991n</span><span class="token punctuation">;</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="限制与建议" tabindex="-1"><a class="header-anchor" href="#限制与建议"><span>限制与建议</span></a></h3>
<blockquote>
<ol>
<li>
<p>精度问题：在处理非常大的数值时，使用 BigInt 可以避免 Number 类型的精度问题。</p>
</li>
<li>
<p>性能考虑：BigInt 操作通常比 Number 操作慢，因为它们需要自定义实现且缺乏本地硬件支持。</p>
</li>
<li>
<p>环境支持：确保你的运行环境支持 BigInt，例如，较老的浏览器或 Node.js 版本可能不支持。</p>
</li>
</ol>
</blockquote>
</div></template>

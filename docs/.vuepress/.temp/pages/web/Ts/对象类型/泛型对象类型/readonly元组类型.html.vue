<template><div><h2 id="readonly-元组类型" tabindex="-1"><a class="header-anchor" href="#readonly-元组类型"><span>Readonly 元组类型</span></a></h2>
<h3 id="定义-readonly-元组类型" tabindex="-1"><a class="header-anchor" href="#定义-readonly-元组类型"><span>定义 Readonly 元组类型</span></a></h3>
<div class="language-typescript line-numbers-mode" data-ext="ts" data-title="ts"><pre v-pre class="language-typescript"><code><span class="token comment">// 定义一个只读元组类型</span>
...
<div class="language-typescript line-numbers-mode" data-ext="ts" data-title="ts"><pre v-pre class="language-typescript"><code><span class="token comment">// 定义一个泛型只读元组类型</span>
...
<div class="language-typescript line-numbers-mode" data-ext="ts" data-title="ts"><pre v-pre class="language-typescript"><code><span class="token comment">// 定义一个包含只读元组属性的对象类型</span>

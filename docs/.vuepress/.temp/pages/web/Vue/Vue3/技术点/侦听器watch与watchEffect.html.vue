<template><div><h2 id="侦听器-watch-与-watcheffect" tabindex="-1"><a class="header-anchor" href="#侦听器-watch-与-watcheffect"><span>侦听器 watch 与 watchEffect</span></a></h2>
<blockquote>
<p>在 Vue 3 中，<code v-pre>watch</code> 和 <code v-pre>watchEffect</code> 是用于响应式侦听的 API，它们允许你对响应式数据的变化做出反应。</p>
</blockquote>
<h3 id="watcheffect" tabindex="-1"><a class="header-anchor" href="#watcheffect"><span><code v-pre>watchEffect</code></span></a></h3>
<blockquote>
<p><code v-pre>watchEffect</code> 侦听器在被创建时立即执行，并在其依赖的响应式数据变化时重新执行。任何 someReactiveSource 或 anotherReactiveSource 的变化都会触发回调函数的重新执行。</p>
</blockquote>
<h4 id="基本用法" tabindex="-1"><a class="header-anchor" href="#基本用法"><span>基本用法</span></a></h4>
<div class="language-javascript line-numbers-mode" data-ext="js" data-title="js"><pre v-pre class="language-javascript"><code><span class="token keyword">import</span> <span class="token punctuation">{</span> watchEffect <span class="token punctuation">}</span> <span class="token keyword">from</span> <span class="token string">"vue"</span><span class="token punctuation">;</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="特点" tabindex="-1"><a class="header-anchor" href="#特点"><span>特点</span></a></h4>
<ol>
<li>自动追踪依赖：watchEffect 会自动追踪其回调函数中用到的响应式数据。</li>
<li>立即执行：watchEffect 创建时会立即执行一次回调函数。</li>
<li>无参访问：回调函数内部无法访问侦听的数据变化。</li>
</ol>
<h3 id="watch" tabindex="-1"><a class="header-anchor" href="#watch"><span>watch</span></a></h3>
<blockquote>
<p>watch 侦听器用于更精细的侦听，允许你指定具体的数据源和选项。</p>
</blockquote>
...
<ol>
<li>明确侦听：你可以指定一个或多个具体的响应式数据源进行侦听。</li>
<li>深入侦听：通过传递选项，可以深入侦听到对象的每个属性。</li>
<li>访问变化数据：回调函数提供了新旧值，以及侦听的数据变化。</li>
</ol>
...
<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>template</span><span class="token punctuation">></span></span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="选择-watch-还是-watcheffect" tabindex="-1"><a class="header-anchor" href="#选择-watch-还是-watcheffect"><span>选择 watch 还是 watchEffect？</span></a></h3>
<ol>
<li>如果你只需要执行副作用而不需要获取新旧值，使用 watchEffect。</li>
<li>如果你需要获取变化的数据或者执行更复杂的逻辑，使用 watch。</li>
<li>watchEffect 更适合用于组件的初始化或全局状态的侦听。</li>
<li>watch 更适合用于细粒度的侦听，例如表单数据的验证。</li>
</ol>
<h3 id="注意事项" tabindex="-1"><a class="header-anchor" href="#注意事项"><span>注意事项</span></a></h3>
<ol>
<li>避免在 watchEffect 中进行重计算或高成本操作，因为它会无条件地重新执行。</li>
<li>使用 watch 时，合理利用 immediate 选项来决定是否在侦听开始时立即触发回调。</li>
<li>考虑使用 deep 选项来侦听复杂数据结构的深层变化。</li>
</ol>
</div></template>

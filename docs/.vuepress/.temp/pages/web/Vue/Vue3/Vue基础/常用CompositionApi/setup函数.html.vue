<template><div><h2 id="setup-函数" tabindex="-1"><a class="header-anchor" href="#setup-函数"><span>setup 函数</span></a></h2>
<blockquote>
<p>Vue3.0 中一个新的配置项，值为一个函数。setup 是所有 Composition API(组合 API)“表演的舞台”。组件中所用到的:数据、方法等等，均要配置在 setup 中。</p>
</blockquote>
<h3 id="setup-函数的两种返回值" tabindex="-1"><a class="header-anchor" href="#setup-函数的两种返回值"><span>setup 函数的两种返回值:</span></a></h3>
<ol>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="setup-的两个注意点" tabindex="-1"><a class="header-anchor" href="#setup-的两个注意点"><span>setup 的两个注意点</span></a></h3>
<h4 id="setup-执行的时机" tabindex="-1"><a class="header-anchor" href="#setup-执行的时机"><span>setup 执行的时机</span></a></h4>
<ul>
<li>在<code v-pre>beforeCreate</code>之前执行一次，<code v-pre>this</code>是<code v-pre>undefined</code>。</li>
</ul>
<h4 id="setup-的参数" tabindex="-1"><a class="header-anchor" href="#setup-的参数"><span>setup 的参数</span></a></h4>
<ul>
<li><strong>props</strong>: 值为对象，包含组件外部传递过来，且组件内部声明接收了的属性。</li>
<li><strong>context</strong>: 上下文对象
<ul>
<li><strong>attrs</strong>: 值为对象，包含组件外部传递过来，但没有在<code v-pre>props</code>配置中声明的属性，相当于<code v-pre>this.$attrs</code>。</li>
<li><strong>slots</strong>: 收到的插槽内容，相当于<code v-pre>this.$slots</code>。</li>
<li><strong>emit</strong>: 分发自定义事件的函数，相当于<code v-pre>this.$emit</code>。</li>
</ul>
</li>
</ul>
<div class="language-vue line-numbers-mode" data-ext="vue" data-title="vue"><pre v-pre class="language-vue"><code><span class="token comment">&lt;!-- App.vue --></span>
<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>template</span><span class="token punctuation">></span></span>

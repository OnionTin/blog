<template><div><h2 id="store-onaction" tabindex="-1"><a class="header-anchor" href="#store-onaction"><span>store.$onAction</span></a></h2>
<blockquote>
<p>监听 action 的执行</p>
</blockquote>
<h3 id="语法" tabindex="-1"><a class="header-anchor" href="#语法"><span>语法</span></a></h3>
<div class="language-javascript line-numbers-mode" data-ext="js" data-title="js"><pre v-pre class="language-javascript"><code>store<span class="token punctuation">.</span><span class="token function">$onAction</span><span class="token punctuation">(</span>
...
<ul>
<li><code v-pre>callback</code>：回调函数，当 action 执行时触发</li>
<li><code v-pre>detached</code>：是否在 store 被销毁时自动移除监听器</li>
</ul>
<h3 id="返回值" tabindex="-1"><a class="header-anchor" href="#返回值"><span>返回值</span></a></h3>
<ul>
<li><code v-pre>() =&gt; void</code>：取消监听器的函数</li>
</ul>

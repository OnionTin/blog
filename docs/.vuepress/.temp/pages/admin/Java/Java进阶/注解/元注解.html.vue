<template><div><h2 id="元注解" tabindex="-1"><a class="header-anchor" href="#元注解"><span>元注解</span></a></h2>
<p>用来标注注解的注解就称为元注解</p>
<table>
<thead>
<tr>
...
<h3 id="target-元注解的参数" tabindex="-1"><a class="header-anchor" href="#target-元注解的参数"><span>@Target 元注解的参数</span></a></h3>
<table>
<thead>
<tr>
<th>参数</th>
...
<td>限制当前注解，只能用来描述类、接口(包括注解类型) 或 enum 声明</td>
</tr>
<tr>
...
<blockquote>
<p>@Target 的参数，其实是 value，但是因为有且只有这一个参数，所以 value 就可以省略了，正常是 value={xxx}；当参数值是数组时，即{ElementType.FIELD,ElementType.METHOD}，那么此时 value 就不能省略了</p>
</blockquote>
<div class="language-java line-numbers-mode" data-ext="java" data-title="java"><pre v-pre class="language-java"><code><span class="token comment">// 只能作用在类上</span>
...
<span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">MyClass</span> <span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="retention-元注解的参数" tabindex="-1"><a class="header-anchor" href="#retention-元注解的参数"><span>@Retention 元注解的参数</span></a></h3>
<table>
<thead>
<tr>
<th>参数</th>
...
<td>存活在源文件中，编译之后就消失了</td>
</tr>
<tr>
<td>RetentionPolicy.CLASS</td>
<td>存活在源文件和字节码文件期间，运行之后就消失了</td>
</tr>
<tr>
<td>RetentionPolicy.RUNTIME</td>
<td>存活在源文件和字节码文件中，运行后不消失</td>
</tr>
</tbody>
</table>
</div></template>

<template><div><h2 id="自定义注解" tabindex="-1"><a class="header-anchor" href="#自定义注解"><span>自定义注解</span></a></h2>
<h3 id="自定义注解格式" tabindex="-1"><a class="header-anchor" href="#自定义注解格式"><span>自定义注解格式</span></a></h3>
<div class="language-java line-numbers-mode" data-ext="java" data-title="java"><pre v-pre class="language-java"><code>元注解
修饰符 <span class="token annotation punctuation">@interface</span> 注解名字<span class="token punctuation">{</span>

<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="最基本的定义使用" tabindex="-1"><a class="header-anchor" href="#最基本的定义使用"><span>最基本的定义使用</span></a></h3>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="反编译探索本质" tabindex="-1"><a class="header-anchor" href="#反编译探索本质"><span>反编译探索本质</span></a></h3>
<ol>
<li>将两个 java 文件(Demo.java A.java)放在同一个文件夹下</li>
<li>在当前文件夹下打开命令行，输入 javac Demo.java A.java</li>
<li>得到三个文件，分别为 Demo.class A.class MyAnno.class</li>
<li>使用 javap MyAnno.class 得到反编译后的文件</li>
<li>观察发现也得到了反编译后的文件内容，这个就是我们要探索的内容</li>
<li>得到内容为：public interface MyAnno1 extends java.lang.annotation.Annotation{}</li>
</ol>
<h3 id="注解的本质" tabindex="-1"><a class="header-anchor" href="#注解的本质"><span>注解的本质</span></a></h3>
<p>public interface MyAnno1 extends java.lang.annotation.Annotation{}</p>
<font color=red>注解底层就是一个接口，该接口默认继承了 Annotation 接口</font>；所以接口怎么写注解就怎么写<h3 id="注解的属性-就是抽象方法" tabindex="-1"><a class="header-anchor" href="#注解的属性-就是抽象方法"><span>注解的属性(就是抽象方法)</span></a></h3>
<p>在接口中有很多抽象方法，在接口中定义的方法叫抽象方法；在注解中定义的抽象方法，叫做注解的属性。</p>
<h3 id="注解属性格式" tabindex="-1"><a class="header-anchor" href="#注解属性格式"><span>注解属性格式</span></a></h3>
<div class="language-java line-numbers-mode" data-ext="java" data-title="java"><pre v-pre class="language-java"><code><span class="token keyword">public</span> <span class="token annotation punctuation">@interface</span> <span class="token class-name">MyAnno1</span> <span class="token punctuation">{</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>返回值数据类型：</p>
<ol>
<li>基本数据类型</li>
<li>String(字符串类型)</li>
<li>Class</li>
<li>enum</li>
<li>Annotation</li>
<li>以及以上所有数据类型的数组类型</li>
</ol>
<h3 id="注解属性的定义与使用" tabindex="-1"><a class="header-anchor" href="#注解属性的定义与使用"><span>注解属性的定义与使用</span></a></h3>
<div class="language-java line-numbers-mode" data-ext="java" data-title="java"><pre v-pre class="language-java"><code><span class="token keyword">package</span> <span class="token namespace">com<span class="token punctuation">.</span>api<span class="token punctuation">.</span></span><span class="token class-name">ZhuJie</span><span class="token punctuation">;</span>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="使用注解的属性注意事项" tabindex="-1"><a class="header-anchor" href="#使用注解的属性注意事项"><span>使用注解的属性注意事项</span></a></h3>
<ol>
<li>注解的多个属性之间使用逗号隔开，属性之间的顺序无所谓</li>
<li>注解的属性可以赋默认值(用 default 设置)，如果有了默认值，则使用注解时，属性不需要赋值了</li>
<li>如果注解有，且只有一个属性时，并且属性的名称是 value，则 value 可以省略，直接定义值即可</li>

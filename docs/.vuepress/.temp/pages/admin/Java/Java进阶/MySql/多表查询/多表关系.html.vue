<template><div><h2 id="多表关系" tabindex="-1"><a class="header-anchor" href="#多表关系"><span>多表关系</span></a></h2>
<h3 id="一对一" tabindex="-1"><a class="header-anchor" href="#一对一"><span>一对一</span></a></h3>
<blockquote>
<p>一个男人只能娶一个媳妇，一个女人也只能嫁给一个男人；一般不会有一对一，因为完全可以把两个表合二为一</p>
</blockquote>
<h3 id="一对多-多对一" tabindex="-1"><a class="header-anchor" href="#一对多-多对一"><span>一对多(多对一)</span></a></h3>
<blockquote>
<p>一个人可以有多个电脑，而一台电脑只能属于一个人</p>
<p>怎么做呢？</p>
<p>一般需要在多的一方添加一个字段，并添加外键关联，关联少的一方的主键</p>
</blockquote>
<div class="language-sql line-numbers-mode" data-ext="sql" data-title="sql"><pre v-pre class="language-sql"><code><span class="token comment">-- user表</span>
...
<p>多个学生上多种课程</p>
<p>多个课程被多个学生选</p>
<p>学生表和课程表之间需要一个中间表，中间表中需要两个外键分别关联学生表和课程表</p>
</blockquote>
<div class="language-sql line-numbers-mode" data-ext="sql" data-title="sql"><pre v-pre class="language-sql"><code><span class="token comment">-- 学生表</span>

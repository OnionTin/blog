<template><div><h2 id="jdbc" tabindex="-1"><a class="header-anchor" href="#jdbc"><span>JDBC</span></a></h2>
<div class="language-java line-numbers-mode" data-ext="java" data-title="java"><pre v-pre class="language-java"><code><span class="token comment">// JDBC 最基础的用法</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="jdbc-基本步骤" tabindex="-1"><a class="header-anchor" href="#jdbc-基本步骤"><span>JDBC 基本步骤</span></a></h3>
<ol>
<li>注册驱动</li>
<li>获取数据库连接对象</li>
<li>获取执行 SQL 的对象</li>
...
<h3 id="获取数据库连接对象" tabindex="-1"><a class="header-anchor" href="#获取数据库连接对象"><span>获取数据库连接对象</span></a></h3>
<table>
<thead>
<tr>
<th>方法</th>
...
<tbody>
<tr>
<td>public static Connection getConnection(String url, String user, String password)</td>
<td>根据地址、用户名、密码连接数据库</td>
</tr>
<tr>
<td>public static Connection getConnection(String url)</td>
<td>根据全路径连接数据库</td>
</tr>
<tr>
<td>public static Connection getConnection(String url, java.util.Properties info)</td>
<td>根据配置文件连接</td>
</tr>
</tbody>
</table>
<h3 id="获取执行-sql-语句的对象" tabindex="-1"><a class="header-anchor" href="#获取执行-sql-语句的对象"><span>获取执行 sql 语句的对象</span></a></h3>
<p>Statement 会有 SQL 注入的风险，所以不推荐使用；解决方案：<RouteLink active to="/db/MySql/预处理语句.md">预处理语句</RouteLink>。</p>
<p>SQL 注入？</p>
<div class="language-java line-numbers-mode" data-ext="java" data-title="java"><pre v-pre class="language-java"><code><span class="token comment">// SQL 注入案例</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="执行-sql-语句" tabindex="-1"><a class="header-anchor" href="#执行-sql-语句"><span>执行 SQL 语句</span></a></h3>
<table>
<thead>
<tr>
<th>方法</th>
...
<td>增删改查；底层使用，我们很少用；查询返回 true, 增删改返回 false</td>
</tr>
</tbody>
</table>
<h3 id="resultset-结果集方法" tabindex="-1"><a class="header-anchor" href="#resultset-结果集方法"><span>ResultSet 结果集方法</span></a></h3>
<table>
<thead>
<tr>
<th>方法</th>
...
<tr>
<td>boolean next()</td>
<td>判断结果集的下一条是否有数据，如果有数据返回 true，并把光标下移一位</td>
</tr>
<tr>
<td>int getInt(int i)</td>
<td>根据当前下标获取数据(1 tom 20：1 的下标 1，tom 下标 2，20 下标 3)</td>
</tr>
<tr>
<td>int getInt(String name)</td>
<td>根据当前字段名获取数据</td>
</tr>
<tr>
<td>String getString(int i)</td>
<td>根据当前下标获取数据</td>
</tr>
<tr>
<td>String getString(String name)</td>
<td>根据当前字段名获取数据</td>
</tr>
</tbody>
</table>

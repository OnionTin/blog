<template><div><h2 id="servletcontext" tabindex="-1"><a class="header-anchor" href="#servletcontext"><span>ServletContext</span></a></h2>
<blockquote>
<p>代表当前的项目，每一个项目，有且只有一个 ServletContext 对象；且只有被服务器部署的项目才有 ServletContext 对象。</p>
</blockquote>
<h3 id="servletcontext-对象生命周期" tabindex="-1"><a class="header-anchor" href="#servletcontext-对象生命周期"><span>ServletContext 对象生命周期</span></a></h3>
<blockquote>
<p>创建：当服务器开启的时候，ServletContext 对象就会被创建出来</p>
<p>销毁：当服务器关闭的时候或者当前的项目被卸载的时候，ServletContext 对象就会被销毁</p>
</blockquote>
<h3 id="获取-servletcontext-对象" tabindex="-1"><a class="header-anchor" href="#获取-servletcontext-对象"><span>获取 ServletContext 对象</span></a></h3>
<h3 id="servletcontext-对象的作用" tabindex="-1"><a class="header-anchor" href="#servletcontext-对象的作用"><span>ServletContext 对象的作用</span></a></h3>
<h4 id="_1-获取响应数据文件的-mimi-类型" tabindex="-1"><a class="header-anchor" href="#_1-获取响应数据文件的-mimi-类型"><span>1. 获取响应数据文件的 MIMI 类型</span></a></h4>
<h4 id="_2-实现数据的共享-转发也可以实现数据共享" tabindex="-1"><a class="header-anchor" href="#_2-实现数据的共享-转发也可以实现数据共享"><span>2. 实现数据的共享(转发也可以实现数据共享)</span></a></h4>
<blockquote>
<p>能够实现数据共享，说明他也是一个域对象(Request 域对象)，他管理的域范围是整个项目(当项目启动了，他的空间产生；当项目关闭时，他的空间消失)</p>
</blockquote>
<blockquote>
<h5 id="servletcontext-域对象与-request-域对象的区别" tabindex="-1"><a class="header-anchor" href="#servletcontext-域对象与-request-域对象的区别"><span>ServletContext 域对象与 Request 域对象的区别</span></a></h5>
<ol>
<li>都可以实现资源共享；但是 Request 需要转发才能实现；但是 ServletContext 生命周期长，不需要转发；</li>
<li>ServletContext 生命周期长，也不安全(比如 n 个人都访问淘宝购买东西存放在购物车，购物车的数据如果存放在 ServletContext 里面，那么每个人的数据都成公开的秘密了)，不是所有的时候都要用；</li>
<li>Request 只有转发才能数据共享，重定向不行；ServletContext 不受转发和重定向的影响，都能实现数据共享。</li>
</ol>
</blockquote>
<table>
<thead>
...
<h4 id="_3-获取资源的真实路径" tabindex="-1"><a class="header-anchor" href="#_3-获取资源的真实路径"><span>3. 获取资源的真实路径</span></a></h4>
<h5 id="加载配置文件" tabindex="-1"><a class="header-anchor" href="#加载配置文件"><span>加载配置文件</span></a></h5>
<ol>
<li>使用类加载器(相对于当前的 classpath 路径下)</li>
<li>通过真实路径获取配置文件(相对于当前项目下)</li>
</ol>
<h5 id="两种加载配置文件的方式的区别" tabindex="-1"><a class="header-anchor" href="#两种加载配置文件的方式的区别"><span>两种加载配置文件的方式的区别</span></a></h5>
<ol>
<li>如果加载的资源在 classpath 路径下，那么推荐使用类加载器方式(实际开发中都在)</li>
<li>如果加载的资源在项目下，在 classpath 路径外，推荐使用真实路径方式</li>
</ol>
<h4 id="_4-获取-web-xml-核心配置文件-中的全局参数" tabindex="-1"><a class="header-anchor" href="#_4-获取-web-xml-核心配置文件-中的全局参数"><span>4. 获取 web.xml(核心配置文件)中的全局参数</span></a></h4>
<div class="language-java line-numbers-mode" data-ext="java" data-title="java"><pre v-pre class="language-java"><code><span class="token keyword">package</span> <span class="token namespace">com<span class="token punctuation">.</span></span><span class="token class-name">ServletContext</span><span class="token punctuation">;</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>ServlerContent 获取配置文件路径：
<img src="@source/admin/Java/Java进阶/images/ServlerContent获取文件路径.jpg" alt="ServlerContent获取文件路径"></p>
<p>classpath 获取配置文件路径：
<img src="@source/admin/Java/Java进阶/images/classpath获取文件路径.jpg" alt="classpath获取文件路径"></p>
</div></template>

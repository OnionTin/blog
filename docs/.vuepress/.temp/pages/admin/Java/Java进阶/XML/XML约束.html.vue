<template><div><h2 id="xml-约束" tabindex="-1"><a class="header-anchor" href="#xml-约束"><span>XML 约束</span></a></h2>
<blockquote>
<p>schema 约束：xsd 格式的约束文档 (推荐使用)</p>
<p>dtd 约束：dtd 格式的约束文档</p>
</blockquote>
<h4 id="根据-dtd-文档编写-xml" tabindex="-1"><a class="header-anchor" href="#根据-dtd-文档编写-xml"><span>根据 dtd 文档编写 xml</span></a></h4>
<blockquote>
<p>ELEMENT：元素；#PCDATA：标签属性</p>
<p>ATTLIST：属性；CDATA：元素属性；#FIXED：固定值；#REQUIRED：必须有值；#IMPLIED：可选值</p>
</blockquote>
<p>案例 1：</p>
<div class="language-dtd line-numbers-mode" data-ext="dtd" data-title="dtd"><pre v-pre class="language-dtd"><code>  &lt;!-- book.dtd --&gt;
  &lt;!ELEMENT 书架 (书+)&gt;
    &lt;!ELEMENT 书 (书名, 作者, 价格)&gt;
      &lt;!ELEMENT 书名 (#PCDATA)&gt;
      &lt;!ELEMENT 作者 (#PCDATA)&gt;
...
<div class="language-dtd line-numbers-mode" data-ext="dtd" data-title="dtd"><pre v-pre class="language-dtd"><code>&lt;!-- student.dtd --&gt;
...
<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>students</span><span class="token punctuation">></span></span>
  ...
  <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>student</span><span class="token punctuation">></span></span>
<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>students</span><span class="token punctuation">></span></span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="根据-xsd-文档编写-xml" tabindex="-1"><a class="header-anchor" href="#根据-xsd-文档编写-xml"><span>根据 xsd 文档编写 xml</span></a></h4>
<blockquote>
<p>schema 约束文档，自身也是一个 xml，其中，根标签的属性是引入的 xsd 的地址</p>
<p>xml 中 xmlns 的值：xsd 文档中 targetNamespace 的值，默认名称空间；</p>
<p>xml 中 xmlns:xsi 的值(xsi: 不固定，别名)：xsd 文档中 xsi:schemaLocation 的值 + &quot;-instance&quot;；</p>
<p>xml 中 xsi(xsi: 同上):schemaLocation 的值：xsd 文档中 targetNamespace 的值 + xsd 文件;</p>
</blockquote>
<p>案例 1：</p>
<div class="language-xsd line-numbers-mode" data-ext="xsd" data-title="xsd"><pre v-pre class="language-xsd"><code>&lt;!-- book.xsd --&gt;
...
<div class="language-xsd line-numbers-mode" data-ext="xsd" data-title="xsd"><pre v-pre class="language-xsd"><code>&lt;!-- shiporder.xsd --&gt;

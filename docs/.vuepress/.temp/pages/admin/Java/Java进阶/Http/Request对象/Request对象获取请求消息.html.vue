<template><div><h2 id="request-对象获取请求消息" tabindex="-1"><a class="header-anchor" href="#request-对象获取请求消息"><span>Request 对象获取请求消息</span></a></h2>
<h3 id="_1-获取请求行数据" tabindex="-1"><a class="header-anchor" href="#_1-获取请求行数据"><span>1. 获取请求行数据</span></a></h3>
<table>
<thead>
<tr>
<th>方法</th>
...
<h3 id="_2-获取请求头数据" tabindex="-1"><a class="header-anchor" href="#_2-获取请求头数据"><span>2. 获取请求头数据</span></a></h3>
<table>
<thead>
<tr>
<th>方法</th>
...
<td>根据请求头获取对应的值，注意值 只能是 int 类型</td>
</tr>
</tbody>
</table>
<h3 id="_3-获取请求体数据" tabindex="-1"><a class="header-anchor" href="#_3-获取请求体数据"><span>3. 获取请求体数据</span></a></h3>
<table>
<thead>
<tr>
<th>方法</th>

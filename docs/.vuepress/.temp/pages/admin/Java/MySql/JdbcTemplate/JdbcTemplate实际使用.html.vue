<template><div><h2 id="jdbctemplate-实际使用-md" tabindex="-1"><a class="header-anchor" href="#jdbctemplate-实际使用-md"><span>JdbcTemplate 实际使用.md</span></a></h2>
<blockquote>
...
│ └── UserTest.java -->
<p>目录结构图：</p>
<p><img src="@source/admin/Java/MySql/images/JdbcTemplate.jpg" alt="JdbcTemplate"></p>

<template><div><h2 id="collection-接口" tabindex="-1"><a class="header-anchor" href="#collection-接口"><span>Collection 接口</span></a></h2>
...
<tr>
<td><font color=red>Object[] toArray()</font></td>
<td><font color=red>集合转数组</font></td>
</tr>
<tr>
<td><code v-pre>Iterator&lt;E&gt; iterator()</code></td>
<td>获取迭代器对象</td>
</tr>
</tbody>
</table>
<h3 id="集合的遍历" tabindex="-1"><a class="header-anchor" href="#集合的遍历"><span>集合的遍历</span></a></h3>
<ol>
<li>转数组循环遍历</li>
</ol>
...
<li>增强 for 循环(for each 遍历)</li>
</ol>
<blockquote>
<p>增强 for 循环底层也是迭代器遍历，只是简化写法</p>
<p>增强 for 循环也可以用来遍历数组</p>
<p>格式：for(数据类型 变量名 : 数组名/集合名){...}</p>
</blockquote>
<div class="language-java line-numbers-mode" data-ext="java" data-title="java"><pre v-pre class="language-java"><code><span class="token class-name">Collection</span> c <span class="token operator">=</span> <span class="token keyword">new</span> <span class="token class-name">ArrayList</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
<span class="token keyword">for</span> <span class="token punctuation">(</span><span class="token class-name">Object</span> obj <span class="token operator">:</span> c<span class="token punctuation">)</span> <span class="token punctuation">{</span>
    <span class="token class-name">System</span><span class="token punctuation">.</span>out<span class="token punctuation">.</span><span class="token function">println</span><span class="token punctuation">(</span>obj<span class="token punctuation">)</span><span class="token punctuation">;</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="方法的应用" tabindex="-1"><a class="header-anchor" href="#方法的应用"><span>方法的应用</span></a></h3>

<template><div><h2 id="异常" tabindex="-1"><a class="header-anchor" href="#异常"><span>异常</span></a></h2>
<p>需要导包，在 java.lang 下</p>
<p>异常的体系结构?
<img src="@source/admin/images/Exception.jpg" alt="异常体系结构"></p>
<h3 id="处理异常" tabindex="-1"><a class="header-anchor" href="#处理异常"><span>处理异常</span></a></h3>
<blockquote>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>抛：throws</p>
<ul>
<li>
<p>被动抛出：throws</p>
<blockquote>
<p>格式：throws 异常类名</p>
<p>写在什么位置：方法声明上</p>
<p>抛的是编译时期(Exception)异常，哪里调用跑哪里，调用方继续处理</p>
<p>抛的是运行时期(RuntimeException)异常，哪里调用抛哪里，调用方不需处理</p>
<p>在子父类中，如果父类没有抛，子类重写方法也不能抛，而且，就算父类抛异常了，</p>
<p>子类抛的异常的类也只能是父类异常的子类或者本身</p>
</blockquote>
</li>
<li>
<p>主动抛出：throw</p>
...
<p>格式：throw 异常对象</p>
<p>写在什么位置：方法体中</p>
<p>抛的是编译时期(Exception)异常，哪里调用跑哪里，调用方不需处理</p>
<p>抛的是运行时期(RuntimeException)异常，哪里调用跑哪里，调用方不需处理</p>
</blockquote>
</li>
</ul>
<p>自定义异常类：需要去继承你想继承的异常(Exception、RuntimeException)</p>
<div class="language-java line-numbers-mode" data-ext="java" data-title="java"><pre v-pre class="language-java"><code><span class="token comment">// 捕获一(多个ctach)</span>

...
<h3 id="动态代理的分类" tabindex="-1"><a class="header-anchor" href="#动态代理的分类"><span>动态代理的分类</span></a></h3>
<ol>
<li>基于接口的动态代理：JDK 动态代理</li>
<li>基于类的 动态代理：CGLIB 动态代理</li>
<li>java 字节码：javasist</li>
</ol>
<h3 id="通过案例理解动态代理" tabindex="-1"><a class="header-anchor" href="#通过案例理解动态代理"><span>通过案例理解动态代理</span></a></h3>
<blockquote>
<p>通过下面的案例，我们只需要定制一套动态代理处理器封装类，之后不管是实现什么功能，只需要传入不同的被代理对象即可；这就是动态代理的好处。</p>
</blockquote>
<div class="language-java line-numbers-mode" data-ext="java" data-title="java"><pre v-pre class="language-java"><code><span class="token comment">// 动态代理处理器封装类</span>

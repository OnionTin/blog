<template><div><h2 id="注解自动扫描装配" tabindex="-1"><a class="header-anchor" href="#注解自动扫描装配"><span>注解自动扫描装配</span></a></h2>
<blockquote>
<p>在注解自动装配的基础上,可以使用自动扫描,这样就不需要在配置文件中一个一个的配置 bean 了</p>
</blockquote>
<h3 id="使用四步骤" tabindex="-1"><a class="header-anchor" href="#使用四步骤"><span>使用四步骤</span></a></h3>
<ol>
<li>导入注解依赖</li>
<li>在配置文件中开启注解支持</li>
<li>配置扫描包</li>
...
<tr>
<td>@Service</td>
<td>在服务层(service)中使用</td>
</tr>
<tr>
<td>@Controller</td>
<td>在控制层(contoller)中使用</td>
</tr>
<tr>
<td>@Repository</td>
<td>在持久层(dao)中使用</td>
...
<tr>
<td>@Scope</td>
<td>设置作用域,默认单例,同 bean,只是注解方式, scopeName 和 value 两个属性</td>
</tr>
</tbody>
</table>
...
<span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">UserService</span> <span class="token punctuation">{</span>
  ...
  <span class="token keyword">public</span> <span class="token class-name">String</span> age<span class="token punctuation">;</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="xml-和注解" tabindex="-1"><a class="header-anchor" href="#xml-和注解"><span>xml 和注解</span></a></h3>
<ol>
<li>xml 适用于任何场景,维护的时候简单</li>
<li>注解,只能在当前类中使用,其他的类获取不到,所以在 spring 项目中很多还是使用 xml</li>
<li>xml 和注解可以混合使用,xml 来管理 bean,用注解来解决属性注入的问题</li>
<li>在后续的 springboot 项目中,都是使用注解,因为注解更加方便</li>
</ol>
</div></template>

<template><div><h2 id="javaconfig-配置" tabindex="-1"><a class="header-anchor" href="#javaconfig-配置"><span>javaConfig 配置</span></a></h2>
<blockquote>
...
<div class="language-java line-numbers-mode" data-ext="java" data-title="java"><pre v-pre class="language-java"><code><span class="token comment">// User</span>

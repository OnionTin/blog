<template><div><!-- @format -->
<h2 id="getmapping-参数和数据响应" tabindex="-1"><a class="header-anchor" href="#getmapping-参数和数据响应"><span>GetMapping 参数和数据响应</span></a></h2>
<div class="language-java line-numbers-mode" data-ext="java" data-title="java"><pre v-pre class="language-java"><code><span class="token comment">// UserController</span>

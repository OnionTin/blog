<template><div><h2 id="feign" tabindex="-1"><a class="header-anchor" href="#feign"><span>Feign</span></a></h2>
<blockquote>
<p>Feign 和 Ribbon 都可以远程接口调用，Feign 中集成了 Ribbon，区别在于 Feign 需要编写接口，而 Ribbon 需要编写配置类。</p>
</blockquote>
<h3 id="ribbon-调用过程" tabindex="-1"><a class="header-anchor" href="#ribbon-调用过程"><span>Ribbon 调用过程</span></a></h3>
<blockquote>
<ol>
...
<h3 id="feign-调用过程" tabindex="-1"><a class="header-anchor" href="#feign-调用过程"><span>Feign 调用过程</span></a></h3>
<blockquote>
<ol>
<li>在 Api 模块中定义接口</li>
<li>在 Api 模块接口中指定@FeignClient(value = &quot;PROJECT-PROVIDER&quot;)</li>
<li>在调用模块启动类加上@EnableFeignClients(basePackages = {&quot;com.ths.api.service&quot;})扫描机制</li>
<li>在调用地方注入接口，调用接口方法即可</li>
</ol>
</blockquote>
<h3 id="feign-的优缺点" tabindex="-1"><a class="header-anchor" href="#feign-的优缺点"><span>Feign 的优缺点</span></a></h3>
<blockquote>
<p>优点：Feign 集成了 Ribbon，Feign 是声明式的，只需要创建一个接口并注解。简化了 Ribbon 的调用方式，只需要创建一个接口并添加注解即可。</p>
<p>缺点：Feign 不支持文件上传，需要使用 Feign 的扩展组件 Feign-form。</p>
</blockquote>
<h3 id="feign-具体步骤" tabindex="-1"><a class="header-anchor" href="#feign-具体步骤"><span>Feign 具体步骤</span></a></h3>
<h4 id="_1-导入依赖" tabindex="-1"><a class="header-anchor" href="#_1-导入依赖"><span>1. 导入依赖</span></a></h4>
<h5 id="_1-1-api-模块" tabindex="-1"><a class="header-anchor" href="#_1-1-api-模块"><span>1.1. api 模块</span></a></h5>
<div class="language-xml line-numbers-mode" data-ext="xml" data-title="xml"><pre v-pre class="language-xml"><code><span class="token comment">&lt;!--导入Feign--></span>
...
<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>dependency</span><span class="token punctuation">></span></span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h5 id="_1-2-调用模块" tabindex="-1"><a class="header-anchor" href="#_1-2-调用模块"><span>1.2. 调用模块</span></a></h5>
<blockquote>
<p>该模块是把 project-consumer-80 中的全都拿了过来，然后去掉 Ribbon，加上 Feign</p>
</blockquote>
<div class="language-xml line-numbers-mode" data-ext="xml" data-title="xml"><pre v-pre class="language-xml"><code><span class="token comment">&lt;!--Feign客户端实现负载均衡--></span>
<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>dependency</span><span class="token punctuation">></span></span>
  <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>groupId</span><span class="token punctuation">></span></span>org.springframework.cloud<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>groupId</span><span class="token punctuation">></span></span>
  <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>artifactId</span><span class="token punctuation">></span></span>spring-cloud-starter-feign<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>artifactId</span><span class="token punctuation">></span></span>
  <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>version</span><span class="token punctuation">></span></span>1.4.6.RELEASE<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>version</span><span class="token punctuation">></span></span>
<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>dependency</span><span class="token punctuation">></span></span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="_2-配置文件" tabindex="-1"><a class="header-anchor" href="#_2-配置文件"><span>2. 配置文件</span></a></h4>
<h5 id="_2-1-调用模块" tabindex="-1"><a class="header-anchor" href="#_2-1-调用模块"><span>2.1 调用模块</span></a></h5>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="_3-编写-api-模块接口" tabindex="-1"><a class="header-anchor" href="#_3-编写-api-模块接口"><span>3. 编写 Api 模块接口</span></a></h4>
<blockquote>
<p>Api 模块中的<font color=red>接口地址必须与微服务(project-provider-8001 等)中提供的地址接口地址保持一致</font>，因为 Feign 会根据接口地址去调用微服务中的接口</p>
</blockquote>
<div class="language-java line-numbers-mode" data-ext="java" data-title="java"><pre v-pre class="language-java"><code><span class="token comment">// 比如这是调用模块中的接口</span>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="_3-调用模块注入接口" tabindex="-1"><a class="header-anchor" href="#_3-调用模块注入接口"><span>3. 调用模块注入接口</span></a></h4>

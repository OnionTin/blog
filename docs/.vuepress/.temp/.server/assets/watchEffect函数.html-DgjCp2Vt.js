...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  _push(`<div${ssrRenderAttrs(_attrs)}><h2 id="vue3-中的-watch-和-watcheffect" tabindex="-1"><a class="header-anchor" href="#vue3-中的-watch-和-watcheffect"><span>Vue3 中的 watch 和 watchEffect</span></a></h2><h3 id="watch-和-watcheffect-的区别" tabindex="-1"><a class="header-anchor" href="#watch-和-watcheffect-的区别"><span>watch 和 watchEffect 的区别</span></a></h3><ul><li>watch：既要指明监视的属性，也要指明监视的回调。</li><li>watchEffect：不用指明监视哪个属性，监视的回调中用到哪个属性，那就监视哪个属性。</li></ul><h3 id="watcheffect-与-computed-的对比" tabindex="-1"><a class="header-anchor" href="#watcheffect-与-computed-的对比"><span>watchEffect 与 computed 的对比</span></a></h3><ul><li><strong>watchEffect</strong> 有点像 <code>computed</code>： <ul><li>但 <code>computed</code> 注重的是计算出来的值（回调函数的返回值），所以必须要写返回值。</li><li>而 <code>watchEffect</code> 更注重的是过程（回调函数的函数体），所以不用写返回值。</li><li><code>watchEffect</code> 所指定的回调中用到的数据只要发生变化，则直接重新执行回调。</li></ul></li></ul><div class="language-javascript line-numbers-mode" data-ext="js" data-title="js"><pre class="language-javascript"><code><span class="token function">watchEffect</span><span class="token punctuation">(</span><span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token operator">=&gt;</span> <span class="token punctuation">{</span>
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../pages/web/Vue/Vue3/Vue基础/常用CompositionApi/watchEffect函数.html.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const watchEffect___html = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender], ["__file", "watchEffect函数.html.vue"]]);

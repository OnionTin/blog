...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../pages/admin/Java/Java常用Api/IO流/字符流/写入/FileReader类.html.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const FileReader__html = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender], ["__file", "FileReader类.html.vue"]]);

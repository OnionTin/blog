...
const _imports_0 = "/blog/assets/JdbcTemplate-ebpWxI61.jpg";
const _sfc_main = {};
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  _push(`<div${ssrRenderAttrs(_attrs)}><h2 id="jdbctemplate-实际使用-md" tabindex="-1"><a class="header-anchor" href="#jdbctemplate-实际使用-md"><span>JdbcTemplate 实际使用.md</span></a></h2><blockquote><p>DAO(Data Access Object): 数据访问对象；</p><p>实际开发中我们修改的都是 Dao，而 JdbcTemplate 只需要引入并创建一个实例就行了;</p><p>其实 JdbcTemplate 就是一个工具类，它封装了 Jdbc 操作的很多细节，提供了很多操作数据库的通用方法，我们用的时候只需要传入 SQL 语句和对应的参数，它就能帮我们完成大部分操作，我们只需要关注 SQL 语句本身，而不用去关注数据库连接、事务处理等这些细节;</p><p>DAO 是我们操作 CURD 的层。</p></blockquote><p>目录结构图：</p><p><img${ssrRenderAttr("src", _imports_0)} alt="JdbcTemplate"></p><div class="language-java line-numbers-mode" data-ext="java" data-title="java"><pre class="language-java"><code>
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../pages/admin/Java/MySql/JdbcTemplate/JdbcTemplate实际使用.html.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const JdbcTemplate_____html = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender], ["__file", "JdbcTemplate实际使用.html.vue"]]);

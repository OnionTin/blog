...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  ...
  _push(`<div${ssrRenderAttrs(_attrs)}><h2 id="hashmap-实现类" tabindex="-1"><a class="header-anchor" href="#hashmap-实现类"><span>HashMap 实现类</span></a></h2><p>和`);
  ...
  _push(`一模一样； 双列集合；需要导包，在 java.util 下； HashMap 是实现类。</p><h3 id="hashmap-集合的特性" tabindex="-1"><a class="header-anchor" href="#hashmap-集合的特性"><span>HashMap 集合的特性</span></a></h3><ol><li>`);
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../pages/admin/Java/Java常用Api/双列集合Map/HashMap实现类.html.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const HashMap____html = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender], ["__file", "HashMap实现类.html.vue"]]);

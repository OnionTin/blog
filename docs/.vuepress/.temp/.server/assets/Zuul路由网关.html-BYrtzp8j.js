...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../pages/admin/Java/SpringCloud/Zuul路由网关.html.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const Zuul_____html = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender], ["__file", "Zuul路由网关.html.vue"]]);

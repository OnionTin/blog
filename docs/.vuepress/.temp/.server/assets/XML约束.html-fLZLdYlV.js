...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  _push(`<div${ssrRenderAttrs(_attrs)}><h2 id="xml-约束" tabindex="-1"><a class="header-anchor" href="#xml-约束"><span>XML 约束</span></a></h2><blockquote><p>schema 约束：xsd 格式的约束文档 (推荐使用)</p><p>dtd 约束：dtd 格式的约束文档</p></blockquote><h4 id="根据-dtd-文档编写-xml" tabindex="-1"><a class="header-anchor" href="#根据-dtd-文档编写-xml"><span>根据 dtd 文档编写 xml</span></a></h4><blockquote><p>ELEMENT：元素；#PCDATA：标签属性</p><p>ATTLIST：属性；CDATA：元素属性；#FIXED：固定值；#REQUIRED：必须有值；#IMPLIED：可选值</p></blockquote><p>案例 1：</p><div class="language-dtd line-numbers-mode" data-ext="dtd" data-title="dtd"><pre class="language-dtd"><code>  &lt;!-- book.dtd --&gt;
  &lt;!ELEMENT 书架 (书+)&gt;
    &lt;!ELEMENT 书 (书名, 作者, 价格)&gt;
      &lt;!ELEMENT 书名 (#PCDATA)&gt;
      &lt;!ELEMENT 作者 (#PCDATA)&gt;
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../pages/admin/Java/Java进阶/XML/XML约束.html.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const XML___html = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender], ["__file", "XML约束.html.vue"]]);
